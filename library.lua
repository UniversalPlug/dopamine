...
local Converted = {
	...
	["_RightSections"] = Instance.new("Frame");
	["_UIListLayout2"] = Instance.new("UIListLayout");
	["_LeftSections"] = Instance.new("Frame");
...
Converted["_RightSections"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_RightSections"].BackgroundTransparency = 1
Converted["_RightSections"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_RightSections"].BorderSizePixel = 0
Converted["_RightSections"].Position = UDim2.new(0.618546128, 0, 0.0383274779, 0)
...
Converted["_LeftSections"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_LeftSections"].BackgroundTransparency = 1
Converted["_LeftSections"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_LeftSections"].BorderSizePixel = 0
Converted["_LeftSections"].Position = UDim2.new(0.236195758, 0, 0.0383274779, 0)
Converted["_LeftSections"].Size = UDim2.new(0, 255, 0, 472)
...
Converted["_Title1"].TextColor3 = Color3.fromRGB(232.00001657009125, 232.00001657009125, 232.00001657009125)
		...
		return {
			...
			AddSection = function(self, title, leftorright, tabTitle)
				...
				function wrappedSection:AddToggle(options)
					local title = options.Text or "Toggle"
					local callback = options.Callback or function() end
				...
				function wrappedSection:AddDropdown(options)
					...
					local function updateSelectedText()
						if #selectedValues == 0 then
							...
							selectedItem.Text = table.concat(displayText, ", ")
						end
					end
